defmodule PhoneNumber do
  ...
  def check_country_code("1" <> rest, 11), do: {:ok, rest}
  def check_country_code(_, 11), do: {:error, "11 digits must start with 1"}
  def check_country_code(str, _), do: {:ok, str}

  def check_area_code(str), do: check_code(str, 0, "area code")
  def check_exchange_code(str), do: check_code(str, 3, "exchange code")
